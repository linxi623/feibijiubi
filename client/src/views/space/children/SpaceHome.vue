        ...
        <div class="col-1">
            ...
            <div class="section video">
                ...
                <div class="video-content">
                    <div class="feature-unavailable">该功能暂未开放</div>
                    <div class="small-item" v-for="(item, index) in videoList" :key="index" v-show="false">
            ...
            <div class="section fav">
                ...
                <div class="fav-content">
                    <div class="feature-unavailable">该功能暂未开放</div>
                    <div v-for="(item, index) in favList" :key="index" v-show="false">
            ...
            <div class="section love">
                ...
                <div class="love-content">
                    <div class="feature-unavailable">该功能暂未开放</div>
                    <div class="small-item" v-for="(item, index) in loveVideos" :key="index" v-show="false">
...
.small-item .cover {
    background: url('~assets/img/feibijiubi/carousel/feibijiubi-carousel-3.jpg') 50%;
...
.fav-covers {
    ...
    overflow: hidden;
    position: relative;
    background: url('~assets/img/feibijiubi/carousel/feibijiubi-carousel-4.jpg') 50%;
    background-size: cover;
    cursor: pointer;
}
